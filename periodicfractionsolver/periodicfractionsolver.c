...
char* pfsSolve(char input[])
{
	...
	snprintf(r, sizeof(r), "%ld / %ld\n", r1 / greatesCommonDivisor,
			r2 / greatesCommonDivisor);

	return r;
}
// emcc PeriodicFractionSolver.c Utils.c -o PeriodicFractionSolver.js -s EXPORTED_FUNCTIONS="['_pfsSolve']" -s EXPORTED_RUNTIME_METHODS="['cwrap']" -s WASM=1